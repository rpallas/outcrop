...
export const STACK_OUTPUTS_HELP = `Usage: outcrop stack-outputs (--stack <name> ... | --outputs-file <cdk-outputs.json>) [--prefix <PREFIX>] [--github-output] [--github-env] [--json <file>] [--region <region>]
