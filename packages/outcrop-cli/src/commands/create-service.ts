...
Scaffolds a new service repository using outcrop.
...
const RUNTIME_DEPS = ["@rpallas/outcrop-runtime"];
const INFRA_DEPS = [
  "@rpallas/outcrop",
  "aws-cdk-lib",
  "constructs",
...
export const dependenciesFor = (
  ...
  if (options.variants.has("neon")) devDependencies.push("@rpallas/outcrop-neon");
