# @rpallas/platform-cdk-runtime

Lambda runtime helpers for services built with `@rpallas/platform-cdk`: structured
...
```sh
npm install @rpallas/platform-cdk-runtime
```
...
```ts
import { platformEnv, requireEnv } from "@rpallas/platform-cdk-runtime";
...
```ts
import { getLogger } from "@rpallas/platform-cdk-runtime";
...
```ts
import { getParameter, platformParams } from "@rpallas/platform-cdk-runtime";
...
```ts
import { getSecret, getSecretJson, getConfig } from "@rpallas/platform-cdk-runtime";
...
```ts
import { publishEvent, publishEvents, parseEnvelope } from "@rpallas/platform-cdk-runtime";
...
```ts
import { withSqsHandler, parseSqsEnvelope } from "@rpallas/platform-cdk-runtime";
...
```ts
import { withEventHandler } from "@rpallas/platform-cdk-runtime";
...
`@rpallas/platform-cdk-runtime/layer` exports `TELEMETRY_LAYER_DIR`,
...
```ts
import { TELEMETRY_LAYER_DIR, TELEMETRY_NODE_OPTIONS } from "@rpallas/platform-cdk-runtime/layer";
