...
export const CREATE_ACCOUNT_HELP = `Usage: platform-cdk create account <name> [options]

Scaffolds an account baseline CDK app using @rpallas/platform-cdk-account.
