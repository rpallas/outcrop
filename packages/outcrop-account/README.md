...
Account and environment baseline for [outcrop](../../README.md). It provisions what every
service built with `@rpallas/outcrop` expects to find in an AWS account and publishes it to
...
import { createAccountBaseline, defineAccountConfig } from "@rpallas/outcrop-account";
