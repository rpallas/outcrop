...
/**
 * Builds the well-known SSM parameter paths of the platform contract (ADR 0003).
 * Written by `@rpallas/platform-cdk-account`, read by the core constructs and by
 * `@rpallas/platform-cdk-runtime` at runtime.
 */
