...
1. `npx @rpallas/outcrop-cli create service <name> [--http-api] [--queue-consumer] [--event-subscriber] [--scheduled] [--static-site] [--dynamodb|--neon] [--auth none|jwt-auth0|jwt-cognito|api-key]`
...
<name>/
  ...
  app/src/handlers/     # Lambda handlers using @rpallas/outcrop-runtime
  app/tests/unit/
